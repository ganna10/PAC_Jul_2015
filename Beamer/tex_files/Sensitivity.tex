...
{
    \usebackgroundtemplate{%
        \vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil\includegraphics[height=0.98\paperheight, width = 0.98\paperwidth]{../Plotting_scripts/CH4_comparison_vertical_mixing}\hfil}\vfil}
    }
    \begin{frame}[plain]
    \end{frame}
}
